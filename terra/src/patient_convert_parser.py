...
path_to_ct_dir = os.path.join(
    pat_dir_path, pat_df["ctSeriesInstanceUID"].values[0])
path_to_rt_dir = os.path.join(
    pat_dir_path, pat_df["rtstructSeriesInstanceUID"].values[0])
patient_convert(path_to_ct_dir, path_to_rt_dir, pat_out_path, pat)
